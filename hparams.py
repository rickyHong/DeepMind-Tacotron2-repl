...
hparams = tf.contrib.training.HParams(
    ...
    # Whether to mask alignments beyond the <stop_token> (False for debug, True for style)
    mask_finished=False,
    ...
    # starting point for learning rate decay (and determines the decay slope) (UNDER TEST)
